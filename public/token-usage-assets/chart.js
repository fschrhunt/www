...
let active=-1,visible=false,muted=false,audio=null,offset=0,pitch=11,first=0,lastTick=0,last=179,guideX=0,guideTarget=0,guideVelocity=0,frame=0,previousTime=0,drag=null,anchorX=innerWidth/2,initialized=false,introPlayed=false;
const cost=n=>'$'+n.toFixed(2);
document.querySelector('#total').textContent='';
// Try audio on load when browser policy permits it; retry on clicks, taps, and key presses.
